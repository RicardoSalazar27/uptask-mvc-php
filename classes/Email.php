...
class Email{
    protected $email; //elemail del usuario
    protected $nombre;
    protected $token;
    ...
    public function enviarConfirmacion(){
        ...
        $mail->setFrom('cuentas@uptask.com'); //email empresa
        ...
        $mail->CharSet = 'UTF-8';
        $contenido = "<html>";
        $contenido .= "<p><strong> Hola " . $this->nombre . "</strong> Has creado tu cuenta en UpTask, solo
